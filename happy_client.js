...
(function (soundMotion) {
    ...
    function handleLoad(_event) {
        ...
        happy1.addEventListener("click", function () { play("./assets/sounds/happy/cant_stop_smilin.mp3"); });
        happy2.addEventListener("click", function () { play("./assets/sounds/happy/because_im_happy.mp3"); });
        happy3.addEventListener("click", function () { play("./assets/sounds/happy/sunshine_in_my_pocket_V2.mp3"); });
